...
OBJ = $(O)mainp.o $(O)initia.o $(O)dmscf.o $(O)misc.o $(O)optocc.o \
      ...
      xcfun_intel/fortran/xcfun_module.o xcfun_intel/fortran/xcfun_autogen.o $(O)vv10.o
...
$(O)mainp.o : $(S)mainp.f $(S)commons.inc $(O)types.o $(O)inputfill.o $(O)systemdef.o $(O)sapt_main.o inputfill.mod sapt_main.mod systemdef.mod types.mod timing.mod
	$(FCC) $(FFLAGS)  -c $(S)mainp.f -o $(O)mainp.o
$(O)initia.o : $(S)initia.f $(S)commons.inc $(O)types.o $(O)sorter.o $(O)tran.o types.mod sorter.mod tran.mod abmat.mod
	$(FCC) $(FFLAGS)  -c $(S)initia.f -o $(O)initia.o 
$(O)misc.o : $(S)misc.f $(S)commons.inc
	$(FCC) $(FFLAGS)  -c $(S)misc.f -o $(O)misc.o
$(O)dmscf.o : $(S)dmscf.f $(S)commons.inc $(O)types.o types.mod
...
$(O)inputfill.o : $(S)inputfill.f90 $(O)types.o types.mod
	$(FCC) $(FFLAGS)  -c $(S)inputfill.f90 -o $(O)inputfill.o
$(O)systemdef.o : $(S)systemdef.f90 $(O)types.o types.mod
	$(FCC) $(FFLAGS)  -c $(S)systemdef.f90 -o $(O)systemdef.o
$(O)sorter.o : $(S)sorter.f90 $(O)types.o types.mod
	$(FCC) $(FFLAGS)  -c $(S)sorter.f90 -o $(O)sorter.o
$(O)tran.o : $(S)tran.f90 $(O)types.o types.mod
	$(FCC) $(FFLAGS)  -c $(S)tran.f90 -o $(O)tran.o
$(O)abmats.o : $(S)abmats.f90 $(O)types.o $(O)tran.o tran.mod types.mod
	$(FCC) $(FFLAGS)  -c $(S)abmats.f90 -o $(O)abmats.o
$(O)abfofo.o : $(S)abfofo.f90 $(O)types.o $(O)tran.o tran.mod types.mod timing.mod
	$(FCC) $(FFLAGS)  -c $(S)abfofo.f90 -o $(O)abfofo.o
$(O)exmisc.o : $(S)exmisc.f90 $(O)types.o types.mod
	$(FCC) $(FFLAGS)  -c $(S)exmisc.f90 -o $(O)exmisc.o
$(O)exdpino.o : $(S)exdpino.f90 $(O)types.o $(O)tran.o $(O)timing.o $(O)exmisc.o tran.mod types.mod timing.mod exmisc.mod
	$(FCC) $(FFLAGS)  -c $(S)exdpino.f90 -o $(O)exdpino.o
$(O)sapt_main.o : $(S)sapt_main.f90 $(O)types.o $(O)systemdef.o $(O)tran.o $(O)sorter.o $(O)sapt.o $(O)abmats.o $(O)abfofo.o $(O)exdpino.o types.mod systemdef.mod timing.mod abmat.mod abfofo.mod tran.mod sorter.mod sapt_ener.mod exd_pino.mod 
...
$(O)vv10.o : $(S)vv10.f $(O)types.o $(S)commons.inc types.mod
...
types.mod :
	$(FCC) $(FFLAGS)  -c $(S)types.f90 -o $(O)types.o
abfofo.mod : types.mod tran.mod timing.mod
	$(FCC) $(FFLAGS)  -c $(S)abfofo.f90 -o $(O)abfofo.o
sorter.mod : types.mod
	$(FCC) $(FFLAGS)  -c $(S)sorter.f90 -o $(O)sorter.o
abmat.mod : types.mod tran.mod
	$(FCC) $(FFLAGS)  -c $(S)abmats.f90 -o $(O)abmats.o
exd_pino.mod : types.mod tran.mod timing.mod exmisc.mod
	$(FCC) $(FFLAGS)  -c $(S)exdpino.f90 -o $(O)exdpino.o
inputfill.mod : types.mod
	$(FCC) $(FFLAGS)  -c $(S)inputfill.f90 -o $(O)inputfill.o
sapt_ener.mod : types.mod tran.mod timing.mod exmisc.mod
	$(FCC) $(FFLAGS)  -c $(S)sapt.f90 -o $(O)sapt.o
sapt_main.mod : types.mod systemdef.mod tran.mod timing.mod abfofo.mod abmat.mod sorter.mod sapt_ener.mod exd_pino.mod
	$(FCC) $(FFLAGS)  -c $(S)sapt_main.f90 -o $(O)sapt_main.o
tran.mod : types.mod
	$(FCC) $(FFLAGS)  -c $(S)tran.f90 -o $(O)tran.o
systemdef.mod : types.mod
	$(FCC) $(FFLAGS)  -c $(S)systemdef.f90 -o $(O)systemdef.o
exmisc.mod : types.mod
	$(FCC) $(FFLAGS)  -c $(S)exmisc.f90 -o $(O)exmisc.o
