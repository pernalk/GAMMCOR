...
C     NBasis READ FROM SIRIUS.RST
      ...
      If(ITREXIO.Eq.1) Call basinfo(NBasis,TrexFile,'TREXIO')
CC
C     *************************************************************************
C
...
C
c     Call ReadTREXIO(XKin,XNuc,ENuc,Occ,URe,TwoEl,UMOAO,
c    $                NAO,NBasis,NInte1,NInte2,TrexFile)
C
      EndIf
C
      print*,'IFunSr: ',IFunSr
