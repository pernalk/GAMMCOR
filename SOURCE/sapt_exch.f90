...
call tran_AO2MO2(Va,B%CAONO(iref2B,:,:),B%CAONO(iref2B,:,:),Vabb,NAO,NBas)
call tran_AO2MO2(Vb,A%CAONO(iref,:,:),  A%CAONO(iref,:,:),  Vbaa,NAO,NBas)
call tran_AO2MO2(Va,A%CAONO(iref,:,:),  B%CAONO(iref2B,:,:),Vaab,NAO,NBas)
call tran_AO2MO2(Vb,B%CAONO(iref2B,:,:),A%CAONO(iref,:,:),  Vbba,NAO,NBas)


! get overlap S matrix in AO and transform to NOs
call get_one_mat('S',S,A%Monomer,NAO)

call tran_AO2MO2(S,A%CAONO(iref,:,:),B%CAONO(iref2B,:,:),Sab,NAO,NBas)
...
RDM2Aval(:,:,:,:) = A%rdm24(iref,:,:,:,:)
RDM2Bval(:,:,:,:) = B%rdm24(iref2B,:,:,:,:)
