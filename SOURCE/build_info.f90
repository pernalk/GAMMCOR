module build_info
    ...
    character(len=*), parameter :: CXX_COMPILER_ID = "Clang"
    character(len=*), parameter :: C_COMPILER_ID = "Clang"
    character(len=*), parameter :: FC_COMPILER = "/opt/intel/oneapi/compiler/2021.1.2/linux/bin/intel64/ifort"
    character(len=*), parameter :: CXX_COMPILER = "/opt/intel/oneapi/compiler/2021.1.2/linux/bin/icpx"
