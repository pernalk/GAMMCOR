...
character(len = 64) :: TREXIO_GIT_HASH = "56a1a5f5d03073977dcf489d2ad305b1313c6115[m"
...
interface
   integer(trexio_exit_code) function trexio_has_rdm_2e_dnup_cholesky_num (trex_file) bind(C)
     use, intrinsic :: iso_c_binding
     import
     integer(trexio_t), intent(in), value :: trex_file
   end function trexio_has_rdm_2e_dnup_cholesky_num
end interface
...
interface
   integer(trexio_exit_code) function trexio_has_rdm_2e_dnup_cholesky (trex_file) bind(C)
     use, intrinsic :: iso_c_binding
     import
     integer(trexio_t), intent(in), value :: trex_file
   end function trexio_has_rdm_2e_dnup_cholesky
end interface
...
interface
   integer(trexio_exit_code) function trexio_read_rdm_2e_dnup_cholesky_num_32 (trex_file, num) bind(C)
     use, intrinsic :: iso_c_binding
     import
     integer(trexio_t), intent(in), value :: trex_file
     integer(c_int32_t), intent(out) :: num
   end function trexio_read_rdm_2e_dnup_cholesky_num_32
end interface
...
interface
   integer(trexio_exit_code) function trexio_read_rdm_2e_dnup_cholesky_num_64 (trex_file, num) bind(C)
     use, intrinsic :: iso_c_binding
     import
     integer(trexio_t), intent(in), value :: trex_file
     integer(c_int64_t), intent(out) :: num
   end function trexio_read_rdm_2e_dnup_cholesky_num_64
end interface
...
interface
   integer(trexio_exit_code) function trexio_read_rdm_2e_dnup_cholesky_num (trex_file, num) bind(C)
     use, intrinsic :: iso_c_binding
     import
     integer(trexio_t), intent(in), value :: trex_file
     integer(c_int32_t), intent(out) :: num
   end function trexio_read_rdm_2e_dnup_cholesky_num
end interface
...
interface
   integer(trexio_exit_code) function trexio_read_rdm_2e_dnup_cholesky (trex_file, &
                                              offset_file, buffer_size, &
                                              index_sparse, value_sparse) bind(C)
     use, intrinsic :: iso_c_binding
     import
     ...
     integer(c_int32_t), intent(out)       :: index_sparse(*)
     real(c_double), intent(out)           :: value_sparse(*)
   end function trexio_read_rdm_2e_dnup_cholesky
end interface

interface
   integer(trexio_exit_code) function trexio_read_safe_rdm_2e_dnup_cholesky (trex_file, &
                                                   offset_file, buffer_size, &
                                                   index_sparse, index_size, &
                                                   value_sparse, value_size) bind(C)
     use, intrinsic :: iso_c_binding
     ...
     real(c_double), intent(out)           :: value_sparse(*)
     integer(c_int64_t), intent(in), value :: value_size
   end function trexio_read_safe_rdm_2e_dnup_cholesky
end interface
...
interface
   integer(trexio_exit_code) function trexio_read_rdm_2e_dnup_cholesky_size (trex_file, &
                                                   size_max) bind(C)
     use, intrinsic :: iso_c_binding
     import
     integer(trexio_t), intent(in), value :: trex_file
     integer(c_int64_t), intent(out) :: size_max
   end function trexio_read_rdm_2e_dnup_cholesky_size
end interface
...
interface
   integer(trexio_exit_code) function trexio_write_rdm_2e_dnup_cholesky_num_32 (trex_file, num) bind(C)
     use, intrinsic :: iso_c_binding
     import
     integer(trexio_t), intent(in), value :: trex_file
     integer(c_int32_t), intent(in), value :: num
   end function trexio_write_rdm_2e_dnup_cholesky_num_32
end interface
...
interface
   integer(trexio_exit_code) function trexio_write_rdm_2e_dnup_cholesky_num_64 (trex_file, num) bind(C)
     use, intrinsic :: iso_c_binding
     import
     integer(trexio_t), intent(in), value :: trex_file
     integer(c_int64_t), intent(in), value :: num
   end function trexio_write_rdm_2e_dnup_cholesky_num_64
end interface
...
interface
   integer(trexio_exit_code) function trexio_write_rdm_2e_dnup_cholesky_num (trex_file, num) bind(C)
     use, intrinsic :: iso_c_binding
     import
     integer(trexio_t), intent(in), value :: trex_file
     integer(c_int32_t), intent(in), value :: num
   end function trexio_write_rdm_2e_dnup_cholesky_num
end interface
...
interface
   integer(trexio_exit_code) function trexio_write_rdm_2e_dnup_cholesky (trex_file, &
                                               offset_file, buffer_size, &
                                               index_sparse, value_sparse) bind(C)
     use, intrinsic :: iso_c_binding
     import
     ...
     integer(c_int32_t), intent(in)        :: index_sparse(*)
     real(c_double), intent(in)            :: value_sparse(*)
   end function trexio_write_rdm_2e_dnup_cholesky
end interface

interface
   integer(trexio_exit_code) function trexio_write_safe_rdm_2e_dnup_cholesky (trex_file, &
                                                    offset_file, buffer_size, &
                                                    index_sparse, index_size, &
                                                    value_sparse, value_size) bind(C)
     use, intrinsic :: iso_c_binding
     ...
     real(c_double), intent(in)            :: value_sparse(*)
     integer(c_int64_t), intent(in), value :: value_size
   end function trexio_write_safe_rdm_2e_dnup_cholesky
end interface
