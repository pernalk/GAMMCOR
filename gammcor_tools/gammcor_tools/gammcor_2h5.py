...
Run inside an old job folder:
    ...
    gammcor_2h5                    # -> pyscf_data.h5
    gammcor_2h5 OLDJOB -o out.h5   # explicit dir / name
    gammcor_2h5 --dry-run          # report only, write nothing

Reproduces the layout written by Pyscf2Gammcor.py.  Anything the legacy
...
# --- auxdata*.txt field names, in the order Pyscf2Gammcor writes them ---
